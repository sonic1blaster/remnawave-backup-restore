...
```
curl -o ~/backup-restore.sh https://raw.githubusercontent.com/sonic1blaster/remnawave-backup-restore/refs/heads/main/backup-restore.sh && chmod +x ~/backup-restore.sh && ~/backup-restore.sh
```
## Commands:
